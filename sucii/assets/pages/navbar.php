...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark border">
        <div class="container col-9 d-flex justify-content-between">
            ...
            <ul class="navbar-nav  mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link text-white" href="index.php"><i class="bi bi-house-door-fill"></i></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="#"><i class="bi bi-chat-right-dots-fill"></i></a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="./assets/images/profile/<?= $user['profile_pic']?>" style="aspect-ratio:1/1;object-fit:cover;" alt="" height="30" class="rounded-circle border">
                    </a>
